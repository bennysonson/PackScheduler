...
public class StudentDirectoryTest {
	...
	/**
	 * tests students added in addStudent() with invalid password.
	 */
	@Test
	...
	/**
	 * Tests whether student that needs to be added in student directory already exists in the directory.
	 */
	@Test
	public void testStudentDuplicate() {
		StudentDirectory sd = new StudentDirectory();
		sd.loadStudentsFromFile(validTestFile);
		assertFalse(sd.addStudent("Zahir", "King", "zking", "orci.Donec@ametmassaQuisque.com", PASSWORD, PASSWORD, 15));
