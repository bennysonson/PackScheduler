...
public class CourseTest {
	...
	public void testCourseStringStringStringIntStringString() {
		...
		try {
			...
			assertEquals(100, c.getCourseRoll().getEnrollmentCap());
		} catch (IllegalArgumentException e) {
			fail();
		}
	}
	...
	public void testSetInstructorId() {
		...
		// 16 Nov 19 (John Preston): Functionality of letting registrar set instructorid to null makes this test useless
...
//		}
	...
	/**
	 * Tests that compareTo returns the correct value which is either -1, 0, or 1.
	 */
	@Test
	public void testCompareTo() {
		Course c1 = new Course("CSC216", "Programming Concepts - Java", "001", 4, "sesmith5", ENROLLMENT_CAP, "MWF", 1330, 1445);
		Course c2 = new Course("CSC216", "Programming Concepts - Java", "002", 4, "sesmith5", ENROLLMENT_CAP, "MWF", 1330, 1445);
		Course c3 = new Course("CSC226", "Discrete Math for Programmers", "001", 4, "sesmith5", ENROLLMENT_CAP, "MWF", 1330, 1445);
        assertEquals(c2.compareTo(c1), -(c1.compareTo(c2)));
        assertEquals(1, c3.compareTo(c1));  
	}
    /**
     * Test get long display array.
     */
    @Test
    public void testGetLongDisplayArray() {
        Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
        
        assertEquals(7, c1.getLongDisplayArray().length);
    }
    /**
     * Test get long display array.
     */
    ...
    public void testGetShortDisplayArray() {
    	Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS);
