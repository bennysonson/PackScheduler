...
public class CourseRecordIOTest {
	...
	public void testReadValidCourseRecords() {
		// have to add faculty to the registration's manager faculty directory for file to be read in properly
		RegistrationManager rm = RegistrationManager.getInstance();
		FacultyDirectory fd = rm.getFacultyDirectory();
		fd.addFaculty("jd", "Young", "jdyoung2", "jdyoung2@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("sp", "Balik", "spbalik", "spbalik@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("tb", "Dimitr", "tbdimitr", "tbdimitr@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("se", "Smith", "sesmith5", "sesmith5@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("jt", "King", "jtking", "jtking@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("ah", "asdfasd", "jep", "jep@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("tm", "Barnes", "tmbarnes", "tmbarnes@ncsu.edu", "pw", "pw", 2);
		fd.addFaculty("db", "Sturgi", "dbsturgi", "dbsturgi@ncsu.edu", "pw", "pw", 2);
